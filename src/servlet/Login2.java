		...
		try{
			...
			else
			{
				...
				else
				{
					...
					session.setAttribute("userID",userID);//第一个参数是这个session的名称
					session.setMaxInactiveInterval(60*60*2);//设置过期时间
					out.write("<script>alert('欢迎使用本系统');window.location.href='./view/user.jsp';</script>");
				}
